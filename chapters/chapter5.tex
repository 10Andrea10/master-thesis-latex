...
\todo[inline]{Create a sequence diagram showing the interaction between the different components of the Rollup System. Say that only the inputs of the programs change, the rest is almost the same.}
...
Since the generation of merkle trees is a very expensive operation, registrations and deregistrations are computed inside dedicated zokrates programs. 

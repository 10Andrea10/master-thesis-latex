...
\todo[inline]{Generate a sequence diagram depicting the interaction among various Rollup System components. Note that while input changes, the remainder remains mostly consistent.}

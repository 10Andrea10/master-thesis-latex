...
\todo[inline]{Explain more the state of the art of the project.}
\todo[inline]{Generate a sequence diagram illustrating the interaction between the various components of the Rollup System. Note that only the input of the programs changes; the remainder remains largely consistent.}
